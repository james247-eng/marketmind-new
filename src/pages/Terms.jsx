...
function Terms() {
  return (
    <>
      <SEO 
        title="Terms Policy - Market Mind | Your Data is Protected"
        description="Market Mind's Terms policy. Learn how we collect, use, and protect your personal information. GDPR and CCPA compliant."
        keywords="Terms policy, data protection, GDPR, CCPA, user Terms, data security"
      />
        ...
        <section className="legal-content">
          <div className="legal-container">
            <div className="legal-text">
              ...
              <h2>Introduction</h2>
              <p>
                At Market Mind, we take your Terms seriously. This Terms Policy explains how we collect, use, disclose, and safeguard your information when you use our social media marketing platform.
              </p>
              ...
              <p>
                We may update this Terms Policy periodically. We will notify you of significant changes via email or prominent notice on our platform.
              </p>

              <h2>Contact Us</h2>
              <p>For Terms-related questions or to exercise your rights, contact us:</p>
              <ul>
                <li>Email: Terms@marketmind.com</li>
